...
// in vk_load.cpp line 301 "Now we can load the samplers from the glTF file."
...
void GLTFMetallic_Roughness::build_pipelines(VulkanEngine* engine) {
    ...
    VK_CHECK(vkCreatePipelineLayout(engine->_device,
            &mesh_layout_info,
            nullptr,
            &newLayout
        )
    ...
    vkDestroyShaderModule(engine->_device,
        meshFragShader,
        nullptr
    );
